...
Ground LLM answers in your own documents using retrieval-augmented generation.
Estimated time: 15 minutes. Prerequisites: Module 02 complete.

Read modules/04-rag-chat-with-your-docs.md but present it in phases:
