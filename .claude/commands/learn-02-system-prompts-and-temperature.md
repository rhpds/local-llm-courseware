...
Control LLM output with system prompts and temperature settings.
Estimated time: 10 minutes. Prerequisites: Module 01 complete or OpenShift lab.

Read modules/02-system-prompts-and-temperature.md but present it in phases:
