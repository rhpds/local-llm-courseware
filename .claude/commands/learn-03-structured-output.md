...
Generate valid JSON and YAML from a local LLM and pipe it into tooling.
Estimated time: 10 minutes. Prerequisites: Module 02 complete.

Read modules/03-structured-output-for-automation.md but present it in phases:
